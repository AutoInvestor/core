...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handlePriceNotAvailableException(
            PriceNotAvailableException ex) {
        return ErrorResponse.builder()
    ...
    public ResponseEntity<ErrorResponse> handlePriceFetchFailedException(
            PriceFetchFailedException ex) {
        return ErrorResponse.builder()
                .status(HttpStatus.INTERNAL_SERVER_ERROR)
                .message(ex.getMessage())
                .build();
